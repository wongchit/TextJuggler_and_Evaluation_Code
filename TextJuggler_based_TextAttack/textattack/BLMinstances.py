...
class InputInstance:
    ...
    def __repr__(self) -> str:
        return f"InputInstance(token_fields={self.token_fields})"
...
class OccludedInstance:
    ...
    def __repr__(self) -> str:
        return f"OccludedInstance(token_fields={self.token_fields}), weight={self.weight})"
    ...
    def from_input_instance(cls,
        ...
        return cls(token_fields=token_fields, weight=weight)
